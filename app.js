...
function render(){
 ...
 $('#stats').innerHTML=[
 ['📅',within.length],
 ['🚁',within.filter(e=>e.outdoor).length],
 ['⭐',within.filter(e=>e.dronePotential==='high').length],
 ['📞',within.filter(e=>e.contact==='todo').length],
 ['🟢',within.filter(e=>e.flight==='accepted').length]
 ...
 list.forEach(e=>{
  ...
  n.querySelector('.potential-badge').textContent=e.dronePotential==='high'?'⭐ Fort potentiel':e.dronePotential==='medium'?'🟢 Potentiel':'⚪ Faible potentiel';
